...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(value = {NoSuchRequestException.class, NoSuchUserException.class, NoSuchItemException.class,
            NoSuchBookingException.class, MismatchedEntityRelationException.class})
